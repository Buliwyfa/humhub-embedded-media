...
/**
 * EmbeddedMediaUploadButtonWidget creates an upload button / system.
 *
 ...
 * @since 0.5
 */
class EmbeddedMediaUploadButton extends \yii\base\Widget
{
    ...
    public function run()
    {
        ...
        return $this->render('embeddedMediaUploadButton', array(
